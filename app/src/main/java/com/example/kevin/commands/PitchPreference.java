...
//one possible option that can be changed in the settings; responsible for the pitch of the TTS engine;
// a caption ('Speech rate') and a SeekBar that allows the user to tune the pitch
// to the desired value between 0.1 and 2 with intervals of 0.1
public class PitchPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    protected View onCreateView(ViewGroup parent){
        ...
        this.monitorBox.setId(R.id.pref_pitch_monitor);
